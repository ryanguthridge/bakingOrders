...
if($_POST){
	...
	include_once("config.php");
	   ...
	   //Sanitize input data using PHP filter_var().
		...
		$query = "UPDATE orders SET name='$name',phone='$phone',email='$email',address='$address',cost='$cost',contactDate='$contactDate',dueDate='$dueDate',orderItems='$orderItems',notes='$notes',paid='$paid' WHERE uuid = '$uuid'";
